...
Now.prototype.initialize = function (server, options) {
  ...
  /**
   * workaround for Socket.IO 
   * see http://stephenbelanger.com/2011/09/21/how-to-make-socket-io-work-behind-nginx-mostly/
   */
  this.server.configure(function() {
    self.server.set("transports", ["xhr-polling"]);
    self.server.set("polling duration", 10);
